...
use sgxlib::{
    ...
    sgx_types::{sgx_calc_quote_size, sgx_create_report, sgx_ra_key_type_t, sgx_report_data_t},
    unsafe_ocall,
};
use sgxlib::{
    ...
    sgx_types::{
        ...
        sgx_get_extended_epid_group_id, sgx_get_quote, sgx_quote_nonce_t, sgx_ra_context_t,
        sgx_ra_msg1_t, sgx_ra_msg2_t, sgx_ra_msg3_t, sgx_ra_proc_msg2, sgx_report_t, sgx_spid_t,
...
impl RaFfi {
    ...
    pub fn get_quote(
        ...
        use sgxlib::sgx_types::sgx_get_quote_size;
        ...
        let quote_size = unsafe {
            ...
            to_result(sgx_get_quote_size(p_sig_rl, &mut size as _))
                .map_err(|err| format!("sgx_calc_quote_size fail: {:?}", err))?;
            size
        };
